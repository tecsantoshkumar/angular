...
@Component({
  selector: 'app-socialmediablog',
  templateUrl: './socialmediablog.component.html',
  styleUrls: ['./socialmediablog.component.scss']
})
export class SocialmediablogComponent implements OnInit {
